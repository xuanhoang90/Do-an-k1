                    ...
                    <form method="POST" action="{{ route('admin.user.update', ['id' => $id]) }}">
                      ...
                      <div class="row">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="name" id="name" placeholder="Please fill your fullname" value="{{old('name', $user->name)}}">
                        </div>
                      ...
                      <button type="submit" class="btn btn-primary btn-color">Update Account</button>
                    </form>
                  </div>
                </div>
              </div>
