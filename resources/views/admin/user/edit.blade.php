          ...
          <div class="row">
            <div class="col-md-2">
              <figure class="figure block-preview-image">
                <div style="width: 150px; height: 150px; overflow: hidden"><img src="{{ $user->profile?->avatar ? asset('storage/' . $user->profile?->avatar) : '/Profile.png' }}" id="preview" class="figure-img img-fluid rounded-circle w-100 h-100" alt="..."></div>
